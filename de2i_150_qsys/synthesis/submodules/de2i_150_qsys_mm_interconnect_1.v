...
module de2i_150_qsys_mm_interconnect_1 (
	...
	wire          pcie_ip_cra_agent_rp_valid;                                      // pcie_ip_cra_agent:rp_valid -> router_001:sink_valid
	wire  [108:0] pcie_ip_cra_agent_rp_data;                                       // pcie_ip_cra_agent:rp_data -> router_001:sink_data
	wire          pcie_ip_cra_agent_rp_ready;                                      // router_001:sink_ready -> pcie_ip_cra_agent:rp_ready
	wire          pcie_ip_cra_agent_rp_startofpacket;                              // pcie_ip_cra_agent:rp_startofpacket -> router_001:sink_startofpacket
	wire          pcie_ip_cra_agent_rp_endofpacket;                                // pcie_ip_cra_agent:rp_endofpacket -> router_001:sink_endofpacket
	...
	wire          router_001_src_valid;                                            // router_001:src_valid -> pcie_ip_cra_rsp_width_adapter:in_valid
	wire  [108:0] router_001_src_data;                                             // router_001:src_data -> pcie_ip_cra_rsp_width_adapter:in_data
	wire          router_001_src_ready;                                            // pcie_ip_cra_rsp_width_adapter:in_ready -> router_001:src_ready
	wire    [1:0] router_001_src_channel;                                          // router_001:src_channel -> pcie_ip_cra_rsp_width_adapter:in_channel
	wire          router_001_src_startofpacket;                                    // router_001:src_startofpacket -> pcie_ip_cra_rsp_width_adapter:in_startofpacket
	wire          router_001_src_endofpacket;                                      // router_001:src_endofpacket -> pcie_ip_cra_rsp_width_adapter:in_endofpacket
	wire          pcie_ip_cra_rsp_width_adapter_src_valid;                         // pcie_ip_cra_rsp_width_adapter:out_valid -> rsp_demux:sink_valid
	wire  [144:0] pcie_ip_cra_rsp_width_adapter_src_data;                          // pcie_ip_cra_rsp_width_adapter:out_data -> rsp_demux:sink_data
	wire          pcie_ip_cra_rsp_width_adapter_src_ready;                         // rsp_demux:sink_ready -> pcie_ip_cra_rsp_width_adapter:out_ready
	wire    [1:0] pcie_ip_cra_rsp_width_adapter_src_channel;                       // pcie_ip_cra_rsp_width_adapter:out_channel -> rsp_demux:sink_channel
	wire          pcie_ip_cra_rsp_width_adapter_src_startofpacket;                 // pcie_ip_cra_rsp_width_adapter:out_startofpacket -> rsp_demux:sink_startofpacket
	wire          pcie_ip_cra_rsp_width_adapter_src_endofpacket;                   // pcie_ip_cra_rsp_width_adapter:out_endofpacket -> rsp_demux:sink_endofpacket
	...
	wire          cmd_mux_src_valid;                                               // cmd_mux:src_valid -> pcie_ip_cra_cmd_width_adapter:in_valid
	wire  [144:0] cmd_mux_src_data;                                                // cmd_mux:src_data -> pcie_ip_cra_cmd_width_adapter:in_data
	wire          cmd_mux_src_ready;                                               // pcie_ip_cra_cmd_width_adapter:in_ready -> cmd_mux:src_ready
	wire    [1:0] cmd_mux_src_channel;                                             // cmd_mux:src_channel -> pcie_ip_cra_cmd_width_adapter:in_channel
	wire          cmd_mux_src_startofpacket;                                       // cmd_mux:src_startofpacket -> pcie_ip_cra_cmd_width_adapter:in_startofpacket
	wire          cmd_mux_src_endofpacket;                                         // cmd_mux:src_endofpacket -> pcie_ip_cra_cmd_width_adapter:in_endofpacket
	...
	wire          pcie_ip_cra_agent_rdata_fifo_src_valid;                          // pcie_ip_cra_agent:rdata_fifo_src_valid -> avalon_st_adapter:in_0_valid
	wire   [33:0] pcie_ip_cra_agent_rdata_fifo_src_data;                           // pcie_ip_cra_agent:rdata_fifo_src_data -> avalon_st_adapter:in_0_data
	wire          pcie_ip_cra_agent_rdata_fifo_src_ready;                          // avalon_st_adapter:in_0_ready -> pcie_ip_cra_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_out_0_valid;                                   // avalon_st_adapter:out_0_valid -> pcie_ip_cra_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_out_0_data;                                    // avalon_st_adapter:out_0_data -> pcie_ip_cra_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_out_0_ready;                                   // pcie_ip_cra_agent:rdata_fifo_sink_ready -> avalon_st_adapter:out_0_ready
	wire    [0:0] avalon_st_adapter_out_0_error;                                   // avalon_st_adapter:out_0_error -> pcie_ip_cra_agent:rdata_fifo_sink_error
	...
	de2i_150_qsys_mm_interconnect_0_avalon_st_adapter_001 #(
		...
		.in_rst_0_reset (pcie_ip_bar2_translator_reset_reset_bridge_in_reset_reset), // in_rst_0.reset
