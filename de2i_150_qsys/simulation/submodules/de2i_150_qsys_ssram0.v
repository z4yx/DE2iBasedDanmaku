...
`timescale 1 ps / 1 ps
module de2i_150_qsys_ssram0 #(
		parameter TCM_ADDRESS_W                  = 22,
		parameter TCM_DATA_W                     = 32,
		parameter TCM_BYTEENABLE_W               = 4,
		parameter TCM_READ_WAIT                  = 0,
		parameter TCM_WRITE_WAIT                 = 0,
		parameter TCM_SETUP_WAIT                 = 0,
		parameter TCM_DATA_HOLD                  = 0,
		...
		output wire        tcm_begintransfer_n_out, //      .begintransfer_n_out
		...
		output wire [3:0]  tcm_byteenable_n_out,    //      .byteenable_n_out
	...
	wire   [3:0] slave_translator_avalon_anti_slave_0_byteenable;    // slave_translator:av_byteenable -> tda:av_byteenable
	wire         slave_translator_avalon_anti_slave_0_begintransfer; // slave_translator:av_begintransfer -> tda:av_begintransfer
