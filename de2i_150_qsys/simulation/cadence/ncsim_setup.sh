...
if [ $SKIP_COM -eq 0 ]; then
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_width_adapter.sv"                                           -work pcie_ip_bar1_0_to_led_s1_cmd_width_adapter -cdslib ./cds_libs/pcie_ip_bar1_0_to_led_s1_cmd_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                       -work pcie_ip_bar1_0_to_led_s1_cmd_width_adapter -cdslib ./cds_libs/pcie_ip_bar1_0_to_led_s1_cmd_width_adapter.cds.lib
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -work pcie_ip_bar1_0_to_led_s1_cmd_width_adapter -cdslib ./cds_libs/pcie_ip_bar1_0_to_led_s1_cmd_width_adapter.cds.lib
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_mm_interconnect_0_rsp_mux_003.sv"                           -work rsp_mux_003                                -cdslib ./cds_libs/rsp_mux_003.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_mm_interconnect_0_rsp_demux_003.sv"                         -work rsp_demux_003                              -cdslib ./cds_libs/rsp_demux_003.cds.lib                             
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_arbitrator.sv"                                              -work cmd_mux_005                                -cdslib ./cds_libs/cmd_mux_005.cds.lib                               
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_mm_interconnect_0_cmd_mux_005.sv"                           -work cmd_mux_005                                -cdslib ./cds_libs/cmd_mux_005.cds.lib                               
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_mm_interconnect_0_cmd_demux_003.sv"                         -work cmd_demux_003                              -cdslib ./cds_libs/cmd_demux_003.cds.lib                             
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter.sv"                                           -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_uncmpr.sv"                                    -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_13_1.sv"                                      -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_adapter_new.sv"                                       -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_incr_burst_converter.sv"                                           -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_wrap_burst_converter.sv"                                           -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_default_burst_converter.sv"                                        -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_address_alignment.sv"                                       -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_stage.sv"                                       -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_avalon_st_pipeline_base.v"                                         -work onchip_memory_s1_burst_adapter             -cdslib ./cds_libs/onchip_memory_s1_burst_adapter.cds.lib            
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_mm_interconnect_0_router_010.sv"                            -work router_010                                 -cdslib ./cds_libs/router_010.cds.lib                                
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_mm_interconnect_0_router_003.sv"                            -work router_003                                 -cdslib ./cds_libs/router_003.cds.lib                                
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/altera_avalon_sc_fifo.v"                                                  -work onchip_memory_s1_agent_rsp_fifo            -cdslib ./cds_libs/onchip_memory_s1_agent_rsp_fifo.cds.lib           
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_slave_agent.sv"                                             -work onchip_memory_s1_agent                     -cdslib ./cds_libs/onchip_memory_s1_agent.cds.lib                    
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/altera_merlin_burst_uncompressor.sv"                                      -work onchip_memory_s1_agent                     -cdslib ./cds_libs/onchip_memory_s1_agent.cds.lib                    
  ...
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_tristate_conduit_pin_sharer_0_arbiter.sv"                   -work arbiter                                    -cdslib ./cds_libs/arbiter.cds.lib                                   
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_tristate_conduit_pin_sharer_0_pin_sharer.sv"                -work pin_sharer                                 -cdslib ./cds_libs/pin_sharer.cds.lib                                
  ...
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/de2i_150_qsys_tristate_conduit_pin_sharer_0.v"                            -work tristate_conduit_pin_sharer_0              -cdslib ./cds_libs/tristate_conduit_pin_sharer_0.cds.lib             
  ncvlog -sv $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/submodules/de2i_150_qsys_tristate_conduit_bridge_0.sv"                               -work tristate_conduit_bridge_0                  -cdslib ./cds_libs/tristate_conduit_bridge_0.cds.lib                 
  ncvlog $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/submodules/de2i_150_qsys_ssram0.v"                                                   -work ssram0                                     -cdslib ./cds_libs/ssram0.cds.lib                                    
